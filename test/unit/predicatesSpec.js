...
describe('Lukkarimaatti predicates tests', () => {
  it('Check course link validity', () => {
    ...
    assert.equal(isCourseLink('https://lukkarimaatti.ltky.fi/?courses='), true)
    assert.equal(isCourseLink('https://lukkarimaatti.ltky.fi/?courses=LM10A2000%20(tite)+LM10A3000%20(tite)+A130A0600+A130A0000+A250A0250+A250A0400+CS10A0010'), true)
